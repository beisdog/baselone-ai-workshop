package ch.erni.ai.demo.market;
...
public class MarketDataService {
    ...
    public MarketDataService(String finnhubApiKey) {
    ...
    /** Get financial metrics including P/E ratio, ROE, 52-week high/low, and valuation assessment*/
    public String getFinancialMetrics(/* stock ticker symbol*/ String symbol) {
        try {
    ...
    /** Get recent company news and market sentiment for the past 7 days*/
    public String getRecentNews(/* stock ticker symbol*/ String symbol) {
        try {
    ...
    /** Get analyst recommendations and trends for a stock*/
    public String getAnalystRecommendations(/* stock ticker symbol*/ String symbol) {
        try {
    ...
    public String calculatePositionSize(/* stock symbol*/ String symbol,
                                       /* account balance in dollars*/ double accountBalance,
                                       /* risk percentage (e.g., 2 for 2%)*/ double riskPercent,
                                       /* entry price*/ double entryPrice,
                                       /* stop loss price*/ double stopLoss) {
